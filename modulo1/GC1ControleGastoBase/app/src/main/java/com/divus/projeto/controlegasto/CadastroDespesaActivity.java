...
public class CadastroDespesaActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Bundle dataOld = getIntent().getBundleExtra(DespesasActivity.KEY_DESPESA);
		
		Bundle data = getIntent().getExtras();
		if (data != null && data.getSerializable(DespesasActivity.KEY_DESPESA) != null) {
	...
	public void inicializarEdicao(Despesa despesa) {
		...
		String[] categorias = this.getResources().getStringArray(R.array.categoria_despesas);
	...
	public void salvarDespesaOnclick(View view) {
		...
		try {
			...
			data.putExtra(DespesasActivity.KEY_DESPESA, despesa);
